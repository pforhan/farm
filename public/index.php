...
switch ($action) {
    case 'upload':
        ...
        include __DIR__ . '/../src/templates/upload_form.php';
        break;
    case 'browse':
        $assets = get_all_assets($conn);
        include __DIR__ . '/../src/templates/browse_assets.php';
        break;
    case 'search':
        $search_results = search_assets($conn, $_GET['query'] ?? '');
        include __DIR__ . '/../src/templates/search_results.php';
        break;
    case 'asset_details':
        ...
        if ($asset_id > 0) {
            ...
            include __DIR__ . '/../src/templates/asset_details.php';
        } else {
